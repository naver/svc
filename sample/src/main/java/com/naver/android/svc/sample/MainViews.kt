...
import com.naver.android.svc.sample.databinding.ActivityMainBinding

class MainViews(screen: MainActivity) : UseCaseViews<MainActivity, ActivityMainBinding, MainUseCase>(screen) {
