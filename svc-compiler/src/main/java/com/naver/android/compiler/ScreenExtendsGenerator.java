...
public class ScreenExtendsGenerator {
    ...
    public ScreenExtendsGenerator(
        String packageName,
        ScreenAnnotatedClass screenAnnotatedClass) {
    ...
    private MethodSpec getCreateViewsMethodSpec() {
        return MethodSpec.methodBuilder("createViews")
            ...
            .addModifiers(Modifier.PUBLIC)
            .addStatement(
                String.format("return new %s()", screenAnnotatedClass.baseViewName))
    ...
    private MethodSpec getControlTowerMethodSpec() {
        return MethodSpec.methodBuilder("getControlTower")
            .addModifiers(Modifier.PUBLIC)
            .addStatement("return ($L) getBaseControlTower()", screenAnnotatedClass.controlTowerName)
            .returns(screenAnnotatedClass.controlTower)
            .build();
    }

    private MethodSpec getViewsMethodSpec() {
